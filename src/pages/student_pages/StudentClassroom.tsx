...
const StudentClassroom = () => {
    ...
    const columns = [
        ...
        { name: 'Link', selector: (row: any) => (<a target='_blank' href={row.link} rel='noreferrer'>{row.link}</a>) },
        { name: 'File', selector: (row: any) => (<a target='_blank' href={row.resource} rel='noreferrer'>{row.resource}</a>) },
