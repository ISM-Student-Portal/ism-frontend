import { getMentorship, getUpcoming, markAttendance } from '@app/services/student/classServices';
...
const Mentorship = () => {
    ...
    const getUpcomingClass = async () => {
        try {
            let classroom1: any = await getMentorship();
    ...
    const columns = [
        ...
        { name: 'Attendance', selector: (row: any) => row.attendance ? (<span className='text-success'>Attended</span>) : row.attendance === null && moment() < moment(row.expires_on) ? (<span></span>) : (<span className='text-danger'>Yet to be Uploaded</span>), },
    ...
    return (
        <div>
            <ContentHeader title="Upcoming Mentorship Class" />
                        ...
                        <Card variant="outlined" sx={{ maxWidth: "600px" }}>
                            ...
                            <Box sx={{ p: 2 }}>
                                ...
                                <Stack direction="row" spacing={1}>
                                    ...
                                    <Button variant='contained' color='success' onClick={getClassLink} >Mark Attendance</Button>
                                </Stack>
                            </Box>
                        </Card>
                    ) : (
