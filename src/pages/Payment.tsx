    ...
    return (
        <div className='h-100'>
            ...
            />Loading... Please wait </div> : (
                ...
                //                             <div className="form-group">
                //                                 <label>Plan</label>
                //                                 <select className="form-control" value={plan} onChange={selectPlan} disabled={outstanding}>
                ...
                //                         <div className="col-md-6">
                //                             <div className="form-group">
                //                                 {outstanding ? <label>Outstanding Amount</label> : <label>{student.is_alumni ? "Discounted Amount (50%)" : "Amount"}</label>}
                ...
                //                                     borderColor: '#C28E27'
                //                                 }
                //                             } disabled={(!amount || !plan || loading) && !outstanding} onClick={() => {
                ...
                // </div>
                <div className="container" style={{ color: '#2A2F54' }}>
                    <div className="my-3 h3">Payment has closed!!!</div>
                    <div>
